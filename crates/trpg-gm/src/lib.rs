...
// CL-EV4Rb deterministic live proof (in-crate: drives the pub(crate) main-GM markup parser +
// admission helper on the real the_vault DB). SKIPs without DATABASE_URL.
#[cfg(test)]
