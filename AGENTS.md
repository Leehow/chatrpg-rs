# ChatRPG Rust Team Lead Adapter

This repository uses the global Codex Team Lead Mode protocol plus the
project-specific continuous pipeline under `docs/team-lead/`.
...
- `docs/team-lead/ProjectPipeline.yaml`
- `docs/team-lead/WorkGraph.yaml`
- `docs/team-lead/AcceptanceLedger.md`
- `docs/team-lead/IntegrationPolicy.md`
- `docs/team-lead/DecisionRights.md`
- `docs/team-lead/ValidationProfiles.md`
